...
const filterImages = () => {
  storeGenres.filteredGenres = storeGenres.genres.filter((image) => image.genre == 'vertex')
}
...
const genresFilter = () => {
  genre.value = genresData.value.find((item) => item.category == 'vertex')
}
  ...
  >
    ...
    >
      ...
      >
        ...
        >
          <span
            class="font-[500] py-[.375rem] px-[1.125rem] border-[1px] bg-darkBG border-vertex z-[1] group-hover:text-vertex group-hover:border-lightText ease-in duration-[.15s] delay-[.05s] sm:py-[.5rem] sm:px-[1.25rem] sm:text-[1.5rem]"
            >Go Back</span
          >
          <span
    ...
    <div
      class="bg-[url('../images/squareGrid.svg')] flex flex-col gap-[1rem] items-center bg-vertex text-darkText py-[2rem] px-[1rem] sm:py-[2.5rem] md:py-[4rem] md:px-[4rem] xxl:px-[12.5rem]"
    >
      ...
      >
        <span
          class="font-[500] py-[.375rem] px-[1.125rem] border-[1px] bg-vertex border-darkBG text-darkText z-[1] group-hover:text-lightText ease-in duration-[.15s] delay-[.05s] sm:py-[.5rem] sm:px-[1.25rem] sm:text-[1.5rem]"
          >Explore Events</span
        >
        <span
