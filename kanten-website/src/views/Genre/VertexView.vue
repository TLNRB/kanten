...
<template>
  ...
  >
    ...
    >
      ...
      >
        <span
          class="font-[500] py-[.375rem] px-[1.125rem] border-[1px] bg-vertex border-darkBG text-darkText z-[1] ease-in duration-[.15s] delay-[.05s] sm:py-[.5rem] sm:px-[1.25rem] sm:text-[1.5rem]"
          >Explore Events</span
        >
        <span
